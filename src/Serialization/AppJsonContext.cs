...
[JsonSerializable(typeof(Nexus.Service.Routes.TryxSlideshowSnapshot))]
...
[JsonSerializable(typeof(Nexus.Service.Models.Klipy.KlipyPanelBgStageRequest))]
...
[JsonSerializable(typeof(VolumeTargetState))]
[JsonSerializable(typeof(SetVolumeTargetBody))]
[JsonSerializable(typeof(SetVolumeTargetMuteBody))]
...
// Conflict launch notice + End task
[JsonSerializable(typeof(Nexus.Service.Helper.Domains.ConflictLaunchNoticePayload))]
[JsonSerializable(typeof(Nexus.Service.Helper.Domains.ConflictEndPayload))]
// Clipboard
...
[JsonSerializable(typeof(Nexus.Service.Routes.Slv3LightingResponse))]
[JsonSerializable(typeof(Nexus.Service.Routes.Slv3ChainLightingDto))]
[JsonSerializable(typeof(Nexus.Service.Routes.Slv3ChainLightingDto[]))]
[JsonSerializable(typeof(Nexus.Service.Routes.Slv3LightingModeDto))]
[JsonSerializable(typeof(Nexus.Service.Routes.Slv3LightingModeDto[]))]
...
// rides the deck preset/instance wire contract (see Nexus.Service.Deck.DeckActionModel).
...
// Deck Modes: host-wide presets + instances (src/Routes/DeckRoutes.cs).
[JsonSerializable(typeof(Nexus.Service.Models.Deck.DeckPresetSummary))]
[JsonSerializable(typeof(List<Nexus.Service.Models.Deck.DeckPresetSummary>))]
...
[JsonSerializable(typeof(Dictionary<string, Nexus.Service.Persistence.DeckInstance>))]
[JsonSerializable(typeof(Nexus.Service.Models.Deck.DeckInstancesResponse))]
