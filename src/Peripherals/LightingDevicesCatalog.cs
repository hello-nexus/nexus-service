...
public static class LightingDevicesCatalog
{
    ...
    private static readonly IReadOnlyList<SupportedDeviceDto> FirstPartyDevices = new List<SupportedDeviceDto>
    {
        ...
        // Galahad II LCD also exposes the same pump RGB interface as the wired Trinity;
        // the other LCD rows remain screen-only until their lighting protocols are verified.
